...
if baseline_strategy:
    ...
    # Recalculate investment results for plotting
    investment_results_baseline, total_value_baseline, _, _ = calculate_scores_and_backtest(
    ...
    # Initialize a new baseline strategy
    ...
    investment_results_baseline, total_value_baseline, overall_return_pct_baseline, positive_return_ratio_baseline = calculate_scores_and_backtest(
        df, initial_columns, initial_ascending_flags
    )
...
yearly_returns_baseline = investment_results_baseline.groupby('year')['gain_pct'].sum()
# Plot the results
